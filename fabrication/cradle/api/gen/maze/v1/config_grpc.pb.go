...
const (
	ConfigService_GetConfig_FullMethodName    = "/maze.v1.ConfigService/GetConfig"
	ConfigService_UpdateConfig_FullMethodName = "/maze.v1.ConfigService/UpdateConfig"
)
...
func (c *configServiceClient) GetConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*LocalAgentConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LocalAgentConfig)
...
func (c *configServiceClient) UpdateConfig(ctx context.Context, in *UpdateConfigRequest, opts ...grpc.CallOption) (*LocalAgentConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LocalAgentConfig)
...
func (UnimplementedConfigServiceServer) GetConfig(context.Context, *GetConfigRequest) (*LocalAgentConfig, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConfig not implemented")
}
func (UnimplementedConfigServiceServer) UpdateConfig(context.Context, *UpdateConfigRequest) (*LocalAgentConfig, error) {
...
var ConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "maze.v1.ConfigService",
