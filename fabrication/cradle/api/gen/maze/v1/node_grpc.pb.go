...
const (
	NodeService_ListNodes_FullMethodName  = "/maze.v1.NodeService/ListNodes"
	NodeService_GetNode_FullMethodName    = "/maze.v1.NodeService/GetNode"
	NodeService_DeleteNode_FullMethodName = "/maze.v1.NodeService/DeleteNode"
)
...
func (c *nodeServiceClient) GetNode(ctx context.Context, in *GetNodeRequest, opts ...grpc.CallOption) (*NodeInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NodeInfo)
...
func (UnimplementedNodeServiceServer) GetNode(context.Context, *GetNodeRequest) (*NodeInfo, error) {
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "maze.v1.NodeService",
