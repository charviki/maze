...
// checks if the SessionServiceUpdateSessionConfigBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionServiceUpdateSessionConfigBody{}
...
func (o SessionServiceUpdateSessionConfigBody) MarshalJSON() ([]byte, error) {
...
type NullableSessionServiceUpdateSessionConfigBody struct {
	value *SessionServiceUpdateSessionConfigBody
	isSet bool
}

func (v NullableSessionServiceUpdateSessionConfigBody) Get() *SessionServiceUpdateSessionConfigBody {
	return v.value
}

func (v *NullableSessionServiceUpdateSessionConfigBody) Set(val *SessionServiceUpdateSessionConfigBody) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionServiceUpdateSessionConfigBody) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionServiceUpdateSessionConfigBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionServiceUpdateSessionConfigBody(val *SessionServiceUpdateSessionConfigBody) *NullableSessionServiceUpdateSessionConfigBody {
	return &NullableSessionServiceUpdateSessionConfigBody{value: val, isSet: true}
}

func (v NullableSessionServiceUpdateSessionConfigBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionServiceUpdateSessionConfigBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
