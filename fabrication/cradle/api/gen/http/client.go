...
// APIClient manages communication with the maze/v1/config.proto API vversion not set
...
type APIClient struct {
	...
	AgentServiceAPI *AgentServiceAPIService

	AuditServiceAPI *AuditServiceAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AgentServiceAPI = (*AgentServiceAPIService)(&c.common)
