...
func (o *V1HostInfo) GetRules() []string {
...
// and a boolean to check if the value has been set.
func (o *V1HostInfo) GetRulesOk() ([]string, bool) {
	if o == nil || IsNil(o.Rules) {
		return nil, false
	}
	return o.Rules, true
...
func (o *V1HostInfo) HasRules() bool {
	if o != nil && !IsNil(o.Rules) {
		return true
	}
...
func (o *V1HostInfo) SetRules(v []string) {
	o.Rules = v
}

// GetGitKeys returns the GitKeys field value if set, zero value otherwise.
func (o *V1HostInfo) GetGitKeys() []string {
...
// and a boolean to check if the value has been set.
func (o *V1HostInfo) GetGitKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.GitKeys) {
		return nil, false
	}
...
func (o *V1HostInfo) HasGitKeys() bool {
	if o != nil && !IsNil(o.GitKeys) {
		return true
	}
...
func (o *V1HostInfo) SetGitKeys(v []string) {
	o.GitKeys = v
}
