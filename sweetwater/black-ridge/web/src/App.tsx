...
import { AgentPanel, DecryptText, BootSequence, TerrainBackground, ErrorBoundary, Button, AnimationSettingsProvider, AnimationSettingsPanel, ToastProvider } from '@maze/fabrication';
    ...
    return (
      <ErrorBoundary>
        <AnimationSettingsProvider>
          <BootSequence onComplete={() => setIsBooting(false)} division="sweetwater" />
        </AnimationSettingsProvider>
      </ErrorBoundary>
    );
  }
