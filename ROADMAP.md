...
- [The Mesa](the-mesa/AGENTS.md) — 控制面域，汇总 Director Core、Director Console 与 Arrival Gate
...
- **Cradle** 是所有 Go 模块的共享基础，被 Director Core 和 Black Ridge 共同依赖
- **Director Console** 通过 Director Core 代理前端请求到 **Black Ridge**
- **Integration Tests** 跨模块验证 Director Core + Black Ridge 的完整链路
